...
## Modeling the unconditional distribution of temperature
...
The input to the neural network is now both an intercept term and the precipitation. The methodology is otherwise identical.
